...
class GenomeTest (unittest.TestCase):
    ...
    def test_tocsv(self):
        g1 = [[1,2,3]]
        genome.Genome.to_csv(g1, '../data/genome/csv/test.csv')
        self.assertTrue(os.path.exists('../data/genome/csv/test.csv'))

    def test_tocsv_content(self):
        g1 = [[1,2,3]]
        genome.Genome.to_csv(g1, '../data/genome/csv/test.csv')
        expect = "1,2,3,\n"
        with open('../data/genome/csv/test.csv') as f:
            csv_str = f.read()
    ...
    def test_from_csv(self):
        g1 = [[1,2,3]]
        genome.Genome.to_csv(g1, '../data/genome/csv/test.csv')
        g2 = genome.Genome.from_csv('../data/genome/csv/test.csv')
        print(g1, g2)
