...
def make_mountain(num_rocks=100, max_size=0.8, arena_size=10, mountain_height=5):
...
dna = genome.Genome.from_csv('../data/genome/csv/elite_50.csv') #100 #88
cr.update_dna(dna)
...
while True:
    ...
    p.resetDebugVisualizerCamera(cameraDistance=10, cameraYaw=75, cameraPitch=-20, cameraTargetPosition=new_pos)
    if step % 120 == 0:
